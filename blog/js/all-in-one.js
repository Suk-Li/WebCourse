...
(function (root, factory) {
  ...
  var BotUI = (function (id, opts) {
    ...
    _searchselect =  "https://blog.shelike.me/botui/vue-select.js";
  ...
  return BotUI;
    ...
    var start = function () { 
      ...
      return botui.message.add({ 
        delay: 1000, 
        content: '本科大学在读，计算机科学与技术专业' 
      }); 
      }).then(function () { 
      return botui.message.add({ 
        delay: 1500, 
        content: '喜欢看动漫，尤其是后宫番；喜欢科幻动作大片，特别是日本动作大片' 
      }); 
      }).then(function () { 
      return botui.message.add({ 
        delay: 1200, 
        content: '喜欢折腾VPS，薅VPS相关的羊毛，搞脚本，尤其喜欢薅羊毛！' 
      }); 
      }).then(function () { 
      return botui.message.add({ 
        delay: 800, 
        content: '喜欢民谣，爱看电影，也爱搞钱！' 
      }); 
      }).then(function () { 
      return botui.message.add({ 
        delay: 2000, 
        content: '电脑游戏只对红警、GTA系列感兴趣，手机游戏只玩QQ飞车、奇迹/闪耀暖暖（当我发现充值是一个无底洞时，退坑了 ）' 
      }); 
      }).then(function () { 
      return botui.message.add({ 
        delay: 1500, 
        content: '曾经对网络安全感兴趣，目前方向是Java，打算努力考研' 
      }); 
      }).then(function () { 
      return botui.action.button({ 
        delay: 1000, 
        action: [{ 
          text: "为什么叫 What's Blog. 呢？ 🤔", 
          value: 'answer1' 
        }, { 
          text: '域名有什么含意吗？(ง •_•)ง', 
          value: 'answer2' 
    ...
    var answer1 = function () { 
      ...
      botui.message.add({ 
        delay: 1500, 
        content: "大一时接触到 django-sspanel 这个漂亮的 ** 面板，它叫 What's SS ，我就拿来用了~" 
      }).then(function () { 
      if(answer_2 == 1){
      return botui.action.button({ 
        delay: 1000, 
...
else{return botui.action.button({ 
        delay: 1000, 
        action: [{ 
          text: '你的博客很漂亮，写的文章帮到了我', 
          value: 'answer3' 
        }] 
      }); }
    }).then(function (res) { 
    ...
    var answer3 = function () { 
      ...
      botui.message.add({ 
        delay: 1000, 
        content: "主要是 H-Siren 这个主题好看啦！" 
      }).then(function () { 
      return botui.message.add({ 
        delay: 1500, 
        content: '如果我的文章对你有所帮助的话，这是我的荣幸 😊' 
      }); 
      }).then(function () { 
      return botui.action.button({ 
        delay: 1000, 
    ...
    var end = function () { 
      botui.message.add({ 
        delay: 1000, 
        content: '![image](../img/image.jpg)' 
      }); 
    }; 
    
if (screen && screen.width < 860) {
        document.getElementById("botui-app").style= "width: 100%; height: 600px; padding: 2px 6px 4px; background-color: rgba(242,242,242,0.5); border-radius: 10px;";
    }