...
// 移动端点击“分类”收缩动画
if (screen && screen.width < 860) {$(function() {
$("a").each(function() {
if ($(this).text().match("分类")) {
$(this).click(function(){
...
// 归档全部展开
function archives(){
	for(var i=0;i<document.getElementsByClassName("archives").length;i++){document.getElementsByClassName("archives")[i].style.display= "block";}
}
            ...
            jQuery(document).on("submit", "#commentform", function() {
                jQuery.ajax({
                    ...
                    success: function(data) {
                        ...
                        t.createButterbar("提交成功，请等待[畅言]审核");
                        $('#comments_edit').html('');
